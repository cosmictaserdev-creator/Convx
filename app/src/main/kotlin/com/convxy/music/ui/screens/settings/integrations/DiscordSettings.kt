...
import com.convxy.music.ui.utils.appTopBarWindowInsets
import com.convxy.music.constants.DiscordAvatarKey
import com.convxy.music.ui.utils.appTopBarWindowInsets
...
import com.convxy.music.ui.utils.appTopBarWindowInsets
import com.convxy.music.constants.DiscordInfoDismissedKey
import com.convxy.music.ui.utils.appTopBarWindowInsets
import com.convxy.music.constants.DiscordNameKey
import com.convxy.music.ui.utils.appTopBarWindowInsets
...
import com.convxy.music.ui.utils.appTopBarWindowInsets
import com.convxy.music.constants.DiscordUsernameKey
import com.convxy.music.ui.utils.appTopBarWindowInsets
...
import com.convxy.music.ui.utils.appTopBarWindowInsets
import com.convxy.music.ui.component.InfoLabel
import com.convxy.music.ui.utils.appTopBarWindowInsets
...
import com.convxy.music.ui.utils.appTopBarWindowInsets
import com.convxy.music.utils.SuperProperties
import com.convxy.music.ui.utils.appTopBarWindowInsets
                ...
                Material3SettingsGroup(
                    ...
                    items = listOf(
                        ...
                        Material3SettingsItem(
                            ...
                            description = {
                                Text(button2Text.ifEmpty { "Visit Convxy" })
                            },
                            trailingContent = {
                                Switch(
        ...
        Column(
            ...
            if (button2Visible) {
                val resolvedButton2 = if (song != null) {
                    DiscordRPC.resolveVariables(
                        button2Text.ifEmpty { "Visit Convxy" }, song
                    )
                } else {
