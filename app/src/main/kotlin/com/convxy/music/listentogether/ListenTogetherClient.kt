...
package com.convxy.music.listentogether
...
import com.convxy.music.constants.ListenTogetherAutoAddSuggestionsKey
import com.convxy.music.constants.ListenTogetherAutoApprovalKey
import com.convxy.music.constants.ListenTogetherIsHostKey
import com.convxy.music.constants.ListenTogetherRoomCodeKey
import com.convxy.music.constants.ListenTogetherServerUrlKey
import com.convxy.music.constants.ListenTogetherSessionTimestampKey
import com.convxy.music.constants.ListenTogetherSessionTokenKey
import com.convxy.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.convxy.music.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.convxy.music.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.convxy.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.convxy.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.convxy.music.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.convxy.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
