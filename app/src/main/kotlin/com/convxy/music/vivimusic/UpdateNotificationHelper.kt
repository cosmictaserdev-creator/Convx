package com.convxy.music.vivimusic
...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/MeYashverma/Convxy/workflows/nightly.yml/main/convxy-gms-nightly.zip"
        } else {
            "https://github.com/MeYashverma/Convxy/releases/download/$versionName/convxy-$versionName.apk"
        }
