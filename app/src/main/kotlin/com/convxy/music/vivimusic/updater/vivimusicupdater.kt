...
package com.convxy.music.vivimusic.updater
...
import com.convxy.music.vivimusic.updater.downloadmanager.UpdateDownloadWorker
import com.convxy.music.vivimusic.updater.downloadmanager.DownloadNotificationManager
...
import com.convxy.music.ui.component.ChangelogItem
import com.convxy.music.ui.component.leadingItemShape
import com.convxy.music.ui.component.middleItemShape
import com.convxy.music.ui.component.endItemShape
import com.convxy.music.ui.component.detachedItemShape
import com.convxy.music.ui.component.AnimatedActionButton
import com.convxy.music.ui.component.ExpressiveIconButton
import com.convxy.music.ui.component.ErrorSnackbar
                                ...
                                Column(
                                    ...
                                    currentStatus.changelog.forEach { section ->
                                        ...
                                        section.items.forEachIndexed { index, item ->
                                            val shape = when {
                                                section.items.size == 1 -> com.convxy.music.ui.component.detachedItemShape()
                                                index == 0 -> com.convxy.music.ui.component.leadingItemShape()
                                                index == section.items.size - 1 -> com.convxy.music.ui.component.endItemShape()
                                                else -> com.convxy.music.ui.component.middleItemShape()
                                            }
                                            com.convxy.music.ui.component.ChangelogItem(
                                                text = item,
                                                shape = shape,
...
private fun fetchNightlyArtifactSize(runId: Long): String = try {
    ...
    val bytes = (0 until (artifacts?.length() ?: 0))
        ...
        .firstOrNull { it.optString("name") == "convxy-gms-nightly" }
    ...
    withContext(Dispatchers.IO) {
        try {
            ...
            if (isNightlyUpdate && nightlyRunObject != null) {
                ...
                val apkDownloadUrl = "https://nightly.link/MeYashverma/Convxy/workflows/nightly.yml/main/convxy-gms-nightly.zip"
